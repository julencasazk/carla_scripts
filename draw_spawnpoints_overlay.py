#!/usr/bin/env python3
"""
Load a CARLA map and overlay spawn point indices into the world using debug draw.

This is meant to be used alongside the normal CARLA viewer/free-camera navigation:
you run this script once, then fly around and read the spawn point numbers.

Example:
  python draw_spawnpoints_overlay.py --map Town04 --lifetime 3600
"""
