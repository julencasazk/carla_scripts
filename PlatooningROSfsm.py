...
This node:
  * Subscribes to:
      <name>/state             : VehicleState, ego sensor state (speed, position, accel, dist_to_prev)
  ...
  * Publishes:
      ...
      /veh_<idx>/cam            : CAM, this vehicle cooperative state
...
class PlatoonMember(Node):
    def __init__(
        ...
        self._brake_mapping_max_dist_m = 35.0
