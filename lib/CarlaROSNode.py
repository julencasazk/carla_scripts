"""
ROS2 node that simulates a discrete longitudinal plant and publishes plant state.

What it does
  - Subscribes to control input u and reference r.
  - Simulates a discrete transfer function (state-space) at fixed Ts.
  - Publishes process variable and PID parameters for plotting/debugging.

Outputs
  - ROS topics: pv, pid_params (and optional plots if enabled).
"""
