#!/usr/bin/env python3
"""
micro-ROS MCU diagnostic logger.

Subscribes to a set of std_msgs/msg/UInt32 topics (e.g. /veh_3/diag/*) and writes
the latest values to a CSV at a fixed rate so you can run it in a separate shell
alongside CARLA/ROS tests.
"""
